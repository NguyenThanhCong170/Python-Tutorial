...
FONT_win = pygame.font.SysFont('Arial',50)
...
def main():
    ...
    dauhieuthuaP2 = False
    dauhieuhoa = False
    P1_WIN_Title = FONT_win.render('Player 1 IS THE WINNER',1,(82, 81, 81))
    P2_WIN_Title = FONT_win.render('Player 2 IS THE WINNER',1,(82, 81, 81))
    Hoa_Title = FONT_win.render('DRAW',1,(82, 81, 81))
    if True:
    ...
    while run:
        ...
        if dauhieuthuaP1 == True:
            WIN.fill((222, 222, 222),(0,0,WIDTH,HEIGHT))
            WIN.blit(P2_WIN_Title,(WIDTH/2 - P2_WIN_Title.get_width()/2,HEIGHT/2 - P2_WIN_Title.get_height()/2))
            pygame.display.update()
            pygame.time.delay(3000)
            break
            

        if dauhieuthuaP2 == True:
            WIN.fill((222, 222, 222),(0,0,WIDTH,HEIGHT))
            WIN.blit(P1_WIN_Title,(WIDTH/2 - P1_WIN_Title.get_width()/2,HEIGHT/2 - P1_WIN_Title.get_height()/2))
            pygame.display.update()
            pygame.time.delay(3000)
            break
        ...
        if dauhieuhoa == True:
            WIN.fill((222, 222, 222),(0,0,WIDTH,HEIGHT))
            WIN.blit(Hoa_Title,(WIDTH/2 - Hoa_Title.get_width()/2,HEIGHT/2 - Hoa_Title.get_height()/2))
            pygame.display.update()
            pygame.time.delay(3000)
            break
